...
# Game Title
pygame.display.set_caption("Snakes By Roshan  ")
...
def welcome():
    ...
    while not exit_game:
        homeimg = pygame.image.load("snakehomeps.jpg")
        ...
        # text_screen("Press Space Bar To Play", white, 205, 550)
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            if abs(snake_x - food_x)<9.5 and abs(snake_y - food_y)<9.5 :
                score +=1
